...
<!--    </div>-->
    ...
    <p class="price">
      <?php if($old_price = render($content['field_old_price'])): ?>
        <span class="amount-title"><?php print t('old price: '); ?></span>
        <del><span class="amount"><?php print t($old_price); ?></span></del>
      <?php endif; ?>
      <span class="amount-title"><?php print t('price: '); ?></span>
      <span class="amount"><?php print t(strip_tags(render($content['display_price']))); ?></span>
    </p>
