...
<div class="views-fluid-grid">
  ...
  <?php endif; ?>
  <ul class="<?php print $list_class; ?> col-lg-12 row">
    <?php foreach ($rows as $id => $item): ?>
      <li class="views-fluid-grid-inline views-fluid-grid-item <?php print $classes_array[$id]; ?> col-lg-3 col-md-6 col-sm-12"><?php print $item; ?></li>
    <?php endforeach; ?>
