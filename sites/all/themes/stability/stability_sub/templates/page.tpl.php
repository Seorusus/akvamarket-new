        ...
        <div class="row">
          <div class="col-sm-6 col-md-8">
            <?php if(theme_get_setting('copyright')) {
              ...
              print t('Copyright') . ' &copy; '. date('Y'); ?>  <a href="/"><?php print strtoupper(variable_get('site_name', 'Akvamarket')); ?></a> &nbsp;| &nbsp; <?php print t('All Rights Reserved');
            }; ?>
          </div>
...
* //  </script>
* //  <noscript><img src="//counter.rambler.ru/top100.cnt?pid=4448955"></noscript>
